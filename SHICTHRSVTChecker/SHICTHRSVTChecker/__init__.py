...
from .utils.api.SHRVTChecker_get_system_slat_stu import SHRVChecker_get_system_slat_stu
...
def SHRVTChecker_get_vt_info() -> dict:
    try:
        ...
        SecondLevelAddressTranslationExtensions_stu : dict = SHRVChecker_get_system_slat_stu(SHRVTCheckerException)
